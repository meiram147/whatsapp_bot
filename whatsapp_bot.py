...
class WhatsApp:
    ...
    def nav_green_dot(self):
        try:
            position = pt.locateOnScreen('img_3.png', confidence=.7)
    ...
    def nav_input_box(self):
        try:
            pt.moveTo(1800, 1000, duration=0.25)
            pt.click(1800, 1000, button='left')
        except Exception as e:
    ...
    def get_message(self):
        pt.moveTo(1377, 902, duration=0.25)
        pt.click(1377, 902, button='left')
        pt.click(1377, 902, button='left')
        pt.mouseDown(button='left')
        pt.moveTo(1800, 902, duration=0.25)
